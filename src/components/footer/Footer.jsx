    ...
    return (
        <>
            <div className=" bg-gray-50 dark:bg-slate-800 dark:text-white py-5 mt-10">
                <footer className="max-w-[2520px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4">
                        <div className="lg:flex">
                            ...
                            <div className="mt-4 lg:flex-1">
                                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                    <div>
                                        <h3 className="text-gray-700 uppercase dark:text-white">Usefull Links</h3>
                                        <a href="/" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Home</a>
                                        <a href="/sign-up" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Sign Up</a>
