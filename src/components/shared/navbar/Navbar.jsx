    ...
    return (
        ...
        <div className="container px-6 py-3 mx-auto md:flex">
          ...
          >
            ...
            <button className="px-5 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Sign Up</button>
            </div>
          </div>
        </div>
      </nav>
